...
local RACE_DB = EnemyRaces.RACE_DB
local getElementMult = EnemyRaces.getElementMult

local EnemyDB = require("data.enemy_db")
local ENEMY_DB = EnemyDB.ENEMY_DB
local BOSS_DB = EnemyDB.BOSS_DB
